...
@Component({
  selector: 'app-teacher-courses-subjects-lesson-single',
  templateUrl: './teacher-courses-subjects-lesson-single.component.html',
  styleUrls: ['./teacher-courses-subjects-lesson-single.component.css']
})
export class TeacherCoursesSubjectsLessonSingleComponent implements OnInit {
